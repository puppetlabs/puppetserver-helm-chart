...
## [v1.3.0](https://github.com/Xtigyro/puppetserver-helm-chart/tree/v1.3.0) (2019-11-28)

- Adds support for separate network protocols or just separate SSH keys which r10k uses to gather the code of the Puppet Control and the Hiera Data repos.
- README and CHANGELOG syntax improvements.
