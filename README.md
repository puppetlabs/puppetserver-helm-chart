...
puppet agent -t --server puppet-compilers --masterport 8140 --test --certname ubuntu-goofy_xtigyro
exit
...
puppet agent -t --server puppet --masterport 8141 --test --certname ubuntu-buggy_xtigyro
exit
